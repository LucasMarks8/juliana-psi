...
const Section2 = () => {
    return (
        <div id='section2' className='flex flex-col'>
            <div className='flex justify-center mt-10 max-xl:mb-10 max-[940px]:mb-10'>
            ...
            <div className='flex items-center justify-center mb-6 h-52 gap-2 max-xl:mb-8 max-xl:grid max-xl:grid-rows-2 max-xl:grid-cols-4 max-xl:h-full max-xl:w-full justify-items-center max-[940px]:grid-cols-2'>
